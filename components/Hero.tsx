...
function Hero() {
  ...
  return (
    <section className="bg-[url('/photos/hero2.jpg')] saturate-200 bg-no-repeat bg-center bg-cover h-screen relative overflow-x-hidden">
      <div className="text-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-full  p-10 bg-gradient-to-r from-[#091e397c] to-[#002049c0] h-full flex items-center justify-center">
        <div data-aos="fade-up" className="px-3 md:px-6 lg:px-40">
